...
module Types
  # The nps replies items
  class NpsRepliesExtension < GraphQL::Schema::FieldExtension
    def resolve(object:, **_rest)
      site_id = object.object[:site_id]
      from_date = object.object[:from_date]
      to_date = object.object[:to_date]

      responses = get_replies(site_id, from_date, to_date)

      {
        trend: get_trend(site_id, from_date, to_date, responses),
        responses: responses
      }
    end
