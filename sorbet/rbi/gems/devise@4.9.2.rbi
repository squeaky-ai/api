...
class ActionDispatch::Routing::Mapper
  ...
  # source://devise_invitable/2.0.7/lib/devise_invitable/routes.rb#6
...
module Devise
  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#78
  ...
  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#40
  def invitation_limit; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#40
  def invitation_limit=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#22
  def invite_for; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#22
  def invite_for=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#49
  def invite_key; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#49
  def invite_key=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#63
  def invited_by_class_name; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#63
  def invited_by_class_name=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#73
  def invited_by_counter_cache; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#73
  def invited_by_counter_cache=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#68
  ...
  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#84
  def require_password_on_accepting; end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#84
  def require_password_on_accepting=(val); end

  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#58
  ...
  # source://devise_invitable/2.0.7/lib/devise_invitable.rb#32
