...
# source://aws-sdk-rails//lib/action_dispatch/session/dynamodb_store.rb#4
module ActionDispatch
  # source://actionpack/7.0.4.3/lib/action_dispatch.rb#99
  def test_app; end
...
# source://aws-sdk-rails//lib/action_dispatch/session/dynamodb_store.rb#5
...
#
# source://aws-sdk-rails//lib/action_dispatch/session/dynamodb_store.rb#17
class ActionDispatch::Session::DynamodbStore < ::Aws::SessionStore::DynamoDB::RackMiddleware
  ...
  #
  # source://aws-sdk-rails//lib/action_dispatch/session/dynamodb_store.rb#21
  def initialize(app, options = T.unsafe(nil)); end

  private

  # source://aws-sdk-rails//lib/action_dispatch/session/dynamodb_store.rb#29
  def config_file; end
end
...
#
# source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_adapter.rb#61
...
class ActiveJob::QueueAdapters::AmazonSqsAdapter
  # source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_adapter.rb#10
  def enqueue(job); end

  # @raise [ArgumentError]
  #
  # source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_adapter.rb#14
  def enqueue_at(job, timestamp); end

  private

  # source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_adapter.rb#22
  def _enqueue(job, body = T.unsafe(nil), send_message_opts = T.unsafe(nil)); end

  # source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_adapter.rb#45
...
#
# source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_async_adapter.rb#17
class ActiveJob::QueueAdapters::AmazonSqsAsyncAdapter < ::ActiveJob::QueueAdapters::AmazonSqsAdapter
  private

  # source://aws-sdk-rails//lib/active_job/queue_adapters/amazon_sqs_async_adapter.rb#21
  def _enqueue(job, body = T.unsafe(nil), send_message_opts = T.unsafe(nil)); end
end
...
#
# source://aws-sdk-rails//lib/aws/rails/ses_mailer.rb#48
...
class Aws::Rails::Notifications < ::Seahorse::Client::Plugin
  # @api private
  #
  # source://aws-sdk-rails//lib/aws/rails/notifications.rb#15
  def add_handlers(handlers, config); end
end

# @api private
#
# source://aws-sdk-rails//lib/aws/rails/notifications.rb#22
class Aws::Rails::Notifications::Handler < ::Seahorse::Client::Handler
  # @api private
  #
  # source://aws-sdk-rails//lib/aws/rails/notifications.rb#24
...
class Aws::Rails::SesMailer
  ...
  #
  # source://aws-sdk-rails//lib/aws/rails/ses_mailer.rb#27
  def deliver!(message); end

  # ActionMailer expects this method to be present and to return a hash.
  #
  # source://aws-sdk-rails//lib/aws/rails/ses_mailer.rb#39
  def settings; end
end
...
class Aws::Rails::Sesv2Mailer
  ...
  # correctly. Called during mail delivery.
  #
  # source://aws-sdk-rails//lib/aws/rails/sesv2_mailer.rb#27
  def deliver!(message); end

  # ActionMailer expects this method to be present and to return a hash.
  #
  # source://aws-sdk-rails//lib/aws/rails/sesv2_mailer.rb#45
  def settings; end
  ...
  #
  # source://aws-sdk-rails//lib/aws/rails/sesv2_mailer.rb#54
...
module Aws::Rails::SqsActiveJob
  class << self
    ...
    # @yield Configuration
    #
    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#13
    def configure; end

    # @return [Boolean]
    #
    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#17
    ...
    #
    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/lambda_handler.rb#13
    def lambda_job_handler(event:, context:); end

    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/lambda_handler.rb#44
    def to_message_attributes(record); end

    # @raise [ArgumentError]
    #
    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/lambda_handler.rb#56
    def to_queue_url(record); end

    # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/lambda_handler.rb#28
...
#
# source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#23
class Aws::Rails::SqsActiveJob::Configuration
  ...
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#86
  def initialize(options = T.unsafe(nil)); end
  ...
  # @api private
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#94
  def client; end
  ...
  # @raise [ArgumentError]
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#99
  ...
  # @api private
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#112
  def to_h; end

  # @api private
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#107
  def to_s; end
  ...
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#140
  def config_file; end

  # @return [String] Configuration path found in environment or YAML file.
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#153
  def config_file_path(options); end

  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#131
  def file_options(options = T.unsafe(nil)); end

  # Load options from YAML file
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#147
  def load_from_file(file_path); end

  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#161
  def load_yaml(file_path); end

  # Set accessible attributes after merged options.
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#125
...
# @api private
#
# source://aws-sdk-rails//lib/aws/rails/sqs_active_job/configuration.rb#27
...
class Aws::Rails::SqsActiveJob::Executor
  ...
  #
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/executor.rb#19
  def initialize(options = T.unsafe(nil)); end
  ...
  # source://aws-sdk-rails//lib/aws/rails/sqs_active_job/executor.rb#43
  def shutdown(timeout = T.unsafe(nil)); end
end

# source://aws-sdk-rails//lib/aws/rails/sqs_active_job/executor.rb#11
...
# source://aws-sdk-rails//lib/aws-sdk-rails.rb#21
Aws::Rails::VERSION = T.let(T.unsafe(nil), String)

# source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#1
module AwsRecord; end

# source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#2
module AwsRecord::Generators; end

# source://aws-sdk-rails//lib/generators/aws_record/base.rb#7
class AwsRecord::Generators::Base < ::Rails::Generators::NamedBase
  # @return [Base] a new instance of Base
  #
  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#25
  ...
  # source://railties/7.0.4.3/lib/rails/generators/named_base.rb#215
  ...
  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#68
  ...
  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#46
  def parse_attributes!; end

  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#172
  def parse_gsis!; end

  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#163
  def parse_rw_units(name); end

  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#141
  def parse_table_config!; end

  # source://aws-sdk-rails//lib/generators/aws_record/base.rb#201
...
class AwsRecord::Generators::GeneratedAttribute
  ...
  #
  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#100
  def initialize(name, type = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#116
  def column_name; end

  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#10
  def field_type; end

  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#124
  def human_name; end
  ...
  # @return [Boolean]
  #
  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#108
  def password_digest?; end

  # @return [Boolean]
  #
  # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#112
  def polymorphic?; end
  ...
  class << self
    ...
    # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#51
    def parse_option(name, opt); end

    # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#71
    def parse_type(name, type); end

    # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#46
    def parse_type_and_options(name, type, opts); end

    # source://aws-sdk-rails//lib/generators/aws_record/generated_attribute.rb#36
...
# source://aws-sdk-rails//lib/generators/aws_record/secondary_index.rb#3
class AwsRecord::Generators::SecondaryIndex
  # @raise [ArgumentError]
  # @return [SecondaryIndex] a new instance of SecondaryIndex
  #
  # source://aws-sdk-rails//lib/generators/aws_record/secondary_index.rb#38
  ...
  class << self
    # source://aws-sdk-rails//lib/generators/aws_record/secondary_index.rb#9
    def parse(key_definition); end

    private

    # source://aws-sdk-rails//lib/generators/aws_record/secondary_index.rb#23
    def get_option_value(raw_option); end

    # source://aws-sdk-rails//lib/generators/aws_record/secondary_index.rb#18
