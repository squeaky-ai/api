...
class Async::Children < ::Async::List
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/node.rb#30
  def nil?; end
  ...
  # source://async//lib/async/node.rb#44
...
#
# source://async//lib/async/node.rb#54
class Async::Node
  ...
  # the parent.
  #
  # source://async//lib/async/node.rb#186
  def consume; end

  # source://async//lib/async/node.rb#121
  def description; end
  ...
  # @private
  #
  # source://async//lib/async/node.rb#80
  def head; end
  ...
  #
  # source://async//lib/async/node.rb#241
  def stop(later = T.unsafe(nil)); end

  # @return [Boolean]
  #
  # source://async//lib/async/node.rb#253
  def stopped?; end
  ...
  # source://async//lib/async/node.rb#166
  def add_child(child); end

  # source://async//lib/async/node.rb#172
  ...
  #
  # source://async//lib/async/node.rb#247
...
class Async::Scheduler < ::Async::Node
  ...
  #
  # source://async//lib/async/scheduler.rb#260
  def async(*arguments, **options, &block); end

  # Invoked when a fiber tries to perform a blocking operation which cannot continue. A corresponding call {unblock} must be performed to allow this fiber to continue.
  #
  # source://async//lib/async/scheduler.rb#109
  def block(blocker, timeout); end

  # source://async//lib/async/scheduler.rb#44
  def close; end
  ...
  # source://async//lib/async/scheduler.rb#276
  ...
  # source://async//lib/async/scheduler.rb#157
  ...
  #
  # source://async//lib/async/scheduler.rb#192
  def process_wait(pid, flags); end

  # Schedule a fiber (or equivalent object) to be resumed on the next loop through the reactor.
  #
  # source://async//lib/async/scheduler.rb#95
  def push(fiber); end

  # source://async//lib/async/scheduler.rb#99
  def raise(*arguments); end

  # source://async//lib/async/scheduler.rb#103
  ...
  #
  # source://async//lib/async/scheduler.rb#199
  def run_once(timeout = T.unsafe(nil)); end

  # source://async//lib/async/scheduler.rb#37
  def scheduler_close; end

  # source://async//lib/async/scheduler.rb#296
  ...
  #
  # source://async//lib/async/scheduler.rb#84
  def transfer; end

  # source://async//lib/async/scheduler.rb#132
  ...
  #
  # source://async//lib/async/scheduler.rb#89
  def yield; end
...
class Async::Task < ::Async::Node
  ...
  #
  # source://async//lib/async/task.rb#166
  def async(*arguments, **options, &block); end
  ...
  # source://async//lib/async/task.rb#85
  def reactor; end

  # Access the result of the task without waiting. May be nil if the task is not completed. Does not raise exceptions.
  #
  # source://async//lib/async/task.rb#199
  def result; end

  # Begin the execution of the task.
  #
  # source://async//lib/async/task.rb#153
  ...
  # @return [Boolean]
  #
  # source://async//lib/async/task.rb#129
  def running?; end

  # @deprecated Prefer {Kernel#sleep} except when compatibility with `stable-v1` is required.
  #
  # source://async//lib/async/task.rb#98
  ...
  # source://async//lib/async/task.rb#93
  def to_s; end
  ...
  #
  # source://async//lib/async/task.rb#103
  def with_timeout(duration, exception = T.unsafe(nil), message = T.unsafe(nil), &block); end
  ...
  # source://async//lib/async/task.rb#305
  ...
  class << self
    ...
    #
    # source://async//lib/async/task.rb#236
    def current; end
    ...
    # @return [Boolean]
    #
    # source://async//lib/async/task.rb#242
    def current?; end
