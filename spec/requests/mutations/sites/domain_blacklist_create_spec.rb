...
RSpec.describe Mutations::Sites::DomainBlacklistCreate, type: :request do
  ...
  context 'when some visitors exist and some have matching domains' do
    ...
    before do
      create(:recording, site:, visitor: create(:visitor, site_id: site.id, external_attributes: { email: 'jim@squeaky.ai' }))
      create(:recording, site:, visitor: create(:visitor, site_id: site.id, external_attributes: { email: 'ray@squeaky.ai' }))
      create(:recording, site:, visitor: create(:visitor, site_id: site.id, external_attributes: { email: 'john@squeaky.ai' }))
      create(:recording, site:, visitor: create(:visitor, site_id: site.id, external_attributes: { email: 'robby@squeaky.ai' }))
      create(:recording, site:, visitor: create(:visitor, site_id: site.id, external_attributes: { email: 'asd@asdas.ai' }))
    end
