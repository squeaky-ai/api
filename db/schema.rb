...
ActiveRecord::Schema[7.0].define(version: 20_221_116_183_444) do
  ...
  create_table 'event_captures', force: :cascade do |t|
    ...
    t.index %w[name site_id], name: 'index_event_captures_on_name_and_site_id', unique: true
  ...
  create_table 'sites', force: :cascade do |t|
    ...
    t.boolean 'anonymise_text', default: false, null: false
    t.integer 'site_type'
